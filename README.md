...
Последнее изменение: 15.12.2025 13:43
...
## Автоматическое обновление даты в README.md

В проекте настроен Git hook, который автоматически обновляет дату последнего изменения в файле README.md при каждом коммите.

Для настройки хука выполните следующие шаги:

1. Убедитесь, что скрипт `pre-commit` находится в директории `.git/hooks/`
...
Альтернативно, вы можете использовать пример скрипта из директории `scripts/`:

1. Скопируйте пример скрипта:
...
После этого при каждом коммите дата в строке "Последнее изменение:" в README.md будет автоматически обновляться до времени создания коммита.

## Конфигурация отладки

Для правильной работы с интерактивными консольными приложениями, такими как [`bin/movement_demo.dart`](bin/movement_demo.dart), необходимо настроить конфигурацию отладки в VSCode. Подробности в файле [`docs/debug_configuration.md`](docs/debug_configuration.md).
